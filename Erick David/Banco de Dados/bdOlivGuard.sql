CREATE DATABASE bdOlivGuard;

USE bdOlivGuard;

CREATE TABLE descricaoSensor(
...
UPDATE descricaoSensor SET localInstalacao = 'Estufa D', dataInstalacao = '2025-03-22 10:00:00'
	WHERE numSerie = 'SN003';
...
ALTER TABLE dadoSensor ADD CONSTRAINT chkStatusSensor 
